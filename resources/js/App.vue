...
<!--                                    <a href="#" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</a>
                                    <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Your links</a>
            ...
            <header class="bg-white shadow">
                <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 h-[40rem]">
...
<!--        <router-link :to="{name: 'home'}">home  |</router-link>
        <router-link :to="{name: 'links'}">your links |</router-link>
        <router-link :to="{name: 'links'}">remove the size |</router-link>-->
